...
public class C11N2Person {
    ...
    public String toString() {
        return "C11N2Person{" + "name: " + name + ", address: " + address
...
class Staff extends Employee {
    ...
    public Staff(String title, String office, double salary, LocalDate hireDate,
            String name, String address, String phone, String email) {
        super(office, salary, hireDate, name, address, phone, email);
        this.title = title;
    }
...
class C11N2Test{
    public static void main(String[] args) {
        C11N2Person p1 = new C11N2Person("James", "4284 Main", "607-4583", "pjames@yahoo.com");
